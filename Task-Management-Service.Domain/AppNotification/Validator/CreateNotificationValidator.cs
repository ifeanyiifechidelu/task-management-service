...
public class CreateNotificationValidator : AbstractValidator<CreateNotificationDto>
{
    ...
    public override ValidationResult Validate(ValidationContext<CreateNotificationDto> context)
    {
        return context.InstanceToValidate == null
            ? new ValidationResult(new[] { new ValidationFailure(nameof(CreateNotificationDto), 
